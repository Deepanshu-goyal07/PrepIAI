...
function S3Report({ report }) {
    ...
    const download = () => {
        ...
        doc.text("AI Interview Performance Report",
            pageWidth / 2,
            currentY, {
            align: "center"
        });
        ...
        doc.text(`Confidence: ${confidence}/10`, margin + 10, currentY + 20);
        doc.text(`Communication: ${communication}/10`, margin + 10, currentY + 27);
        doc.text(`Correctness: ${correctness}/10`, margin + 10, currentY + 34);
        currentY += 46;
        ...
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 px-4 sm:px-6 lg:px-10 py-8">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="w-full flex items-start gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800">Interview Analytics</h1>
                        <p className="text-gray-500 mt-2">AI-powered feedback for your interview</p>
                    </div>
                </div>
                <button
                    onClick={download}
                    className="bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-6 rounded-xl 
                shadow-md transition-all duration-300 font-semibold text-sm sm:text-base whitespace-nowrap cursor-pointer">
                    Download PDF
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                <div className="space-y-6">
                    <motion.div
                        ...
                        <div className="relative w-20 h-20 sm:w-25 sm:h-25 mx-auto mt-4">
                            <CircularProgressbar
                                value={percentage}
                                text={`${score}/10`}
                                styles={buildStyles({
                            ...
                            {questionWiseScore.map((q, i) => (
                                <div key={i} className="bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200">
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                                        ...
                                        <div className="bg-blue-100 text-blue-600 px-3 py-1 rounded-full font-bold text-xs sm:text-sm w-fit whitespace-nowrap">
                                            {q.score ?? 0} / 10
                                        </div>
                                    </div>
                                    <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                                        ...
                                        <p className="text-xs text-gray-700 leading-relaxed">
                                            {q.feedback && q.feedback.trim() !== "N/A"
                                                ? q.feedback
