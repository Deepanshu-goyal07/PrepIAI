...
function Pricing() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-5 py-16 px-6">
                    ...
                    return (
                        <motion.div key={plan.id}
                            ...
                            className={`relative rounded-3xl p-8 transition-all duration-300 border
                                ${isSelected ? "border-blue-500 shadow-2xl bg-white" : "border-gray-200 bg-white shadow-md"}
                        ...
                        >
                            ...
                            {!plan.default &&
                                <button className={`w-full mt-8 py-3 rounded-xl font-semibold transition
                                      ${isSelected ? "bg-blue-600 text-white hover:opacity-90" : "bg-gray-100 text-gray-700 hover:bg-blue-50"
                                    }`}>
